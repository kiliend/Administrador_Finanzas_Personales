...
public class GastosConexionDB {
    ...
    private static final String URL_INGRESOS = "jdbc:mysql://localhost:3306/finanzaspersonales";
    private static final String URL_GASTOS = "jdbc:mysql://localhost:3306/finanzaspersonales";
